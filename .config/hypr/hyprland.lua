...
-- Monitores e teclado (hardware) ficam em hardware.lua, compartilhado por todos os temas
require("hardware")
...
-- Modus (github.com/S4NKALP/Modus) sobe o próprio bar/dock/notificações —
...
hl.config({
    general = {
        ...
        col = {
            active_border   = "rgba(e8e8e8dd)",
            inactive_border = "rgba(3a3a3a80)",
        },
...
-- Trazidos do repo antigo (github.com/pedrohkf/Arch-Linux)
hl.bind(mainMod .. " + F", hl.dsp.exec_cmd("wofi --show drun"))

-- Spotlight-like: Super+Alt+Space abre o launcher de apps (sem conflito com troca de idioma em Super+Space)
...
-- Screenshot de área selecionada pro clipboard: Print (padrão antigo) e
-- Super+Shift+S (igual o Snipping Tool do Windows)
hl.bind("Print", hl.dsp.exec_cmd('grim -g "$(slurp)" - | wl-copy'))
hl.bind(mainMod .. " + SHIFT + S", hl.dsp.exec_cmd('grim -g "$(slurp)" - | wl-copy'))

-- Redimensionar janela ativa com mainMod + ALT + setas
...
-- Special workspace (scratchpad) — Super+S e Super+Shift+S já são do
-- screenshot (acima) e do screencapture region do Modus, então o scratchpad
-- vai pro Alt em vez de Shift
...
-- Volume/brilho/mic ficam por conta do Modus aqui (mesmas teclas XF86, com OSD próprio)
