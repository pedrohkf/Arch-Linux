...
hl.on("hyprland.start", function ()
  hl.exec_cmd([[flock /tmp/waybar-guard.lock -c 'pgrep -x waybar >/dev/null || waybar']])
end)
...
-- Print: screenshot de uma área selecionada pro clipboard
-- (era Super+Shift+S no repo antigo, mas essa tecla já está em uso pro workspace especial)
